...
- У нас реализована **кастомная система апрувов**. Вам понадобится перейти во вкладу "changes" и отправить в качестве комментария: 👍. И тогда ваш голос будет учтен)). Вы можете удалить свой комментарий с лайком, и тогда ваш aprove будет удален. \
**NOTE:** self-aprove - запрещен!
